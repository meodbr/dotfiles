...
tnoremap <C-Left> <C-\><C-N>:vertical resize +3<CR>
tnoremap <C-Down> <C-\><C-N>:resize +3<CR>
tnoremap <C-Up> <C-\><C-N>:resize -3<CR>
tnoremap <C-Right> <C-\><C-N>:vertical resize -3<CR>
inoremap <C-Left> <C-\><C-N>:vertical resize +3<CR>
inoremap <C-Down> <C-\><C-N>:resize +3<CR>
inoremap <C-Up> <C-\><C-N>:resize -3<CR>
inoremap <C-Right> <C-\><C-N>:vertical resize -3<CR>
